...
<Note>
  The basic template doesn't include tests by default, but you can add them using `@bunli/test`. See the [Testing Guide](/guides/testing) for details.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Add Plugins" icon="plug" href="/guides/plugins">
