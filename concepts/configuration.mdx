...
<ParamField path="plugins" type="PluginConfig[]" default="[]">
  ...
  See [Plugins](/guides/plugins) for details.
</ParamField>
...
- [Plugins](/guides/plugins) - Extend Bunli with plugins
- [Building](/guides/building) - Build and distribute your CLI
- [Configuration API](/api/config) - Configuration utilities